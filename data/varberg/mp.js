function loadMarkersForMP() {
	...
	var mpLinneaSandahl = L.marker([57.2670,12.3358], {icon: partyIcons["mp"]})
		.bindPopup("2. <b>Linnea Sandahl</b>, 25<br>Jämställdhets- och mångfaldssamordnare<br>Veddige");
	var mpSamuelLindh = L.marker([57.1103,12.2684], {icon: partyIcons["mp"]})
	...
	var mpPeterBjorck = L.marker([57.1082,12.2790], {icon: partyIcons["mp"]})
