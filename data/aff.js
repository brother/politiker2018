function loadMarkersForAFF() {
	var affAndreasFeymark = L.marker([57.1460,12.4554], {icon: partyIcons["aff"]})
		.bindPopup("1. <b>Andreas Feymark</b>, 34<br>Teknologie doktor");
	var affJohannaPalmelid = L.marker([57.1460,12.4541], {icon: partyIcons["aff"]})
		.bindPopup("2. <b>Johanna Palmelid</b>, 36<br>Beteendevetare");
	var affHannaGotz = L.marker([57.1460,12.4565], {icon: partyIcons["aff"]})
