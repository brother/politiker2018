function loadMarkersForKD() {
	...
	var kdEmilyCrowe = L.marker([56.9008,12.4914], {icon: partyIcons["kd"]})
		.bindPopup("2. <b>Emily Crowe</b>, 38<br>Studerande<br>Falkenberg");
	var kdAnitaAndersson = L.marker([56.9311,12.3648], {icon: partyIcons["kd"]})
		.bindPopup("3. <b>Anita Andersson</b>, 73x<br>f.d. Verksamhetschef<br>Glommen");
	...
	var kdDanielBernhardt = L.marker([56.8978,12.4791], {icon: partyIcons["kd"]})
